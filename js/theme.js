...
const theme = {
  ...
  set(name, save = true) {
    ...
    document.body.style.background = `url("./images/logo_${
      isLight ? "white" : "black"
    }.svg") center center / 33% no-repeat ${isLight ? "#e0e1e2" : "#1b1c1d"} `;
...
// Theme handling
const LIGHT_THEME_STYLESHEET = document.getElementById(
  "judge0-golden-layout-light-theme-stylesheet"
);
const DARK_THEME_STYLESHEET = document.getElementById(
  "judge0-golden-layout-dark-theme-stylesheet"
);
...
export function setTheme(theme) {
  ...
  if (theme === "light") {
    LIGHT_THEME_STYLESHEET.removeAttribute("disabled");
    DARK_THEME_STYLESHEET.setAttribute("disabled", "");
  } else {
    DARK_THEME_STYLESHEET.removeAttribute("disabled");
    LIGHT_THEME_STYLESHEET.setAttribute("disabled", "");
  }
